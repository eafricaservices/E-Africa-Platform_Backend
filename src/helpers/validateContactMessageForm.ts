...
interface ContactMessageFormData {
    fullName: string;
    email: string;
    phone: string;
    message: string;
...
interface ValidationResult {
    errors: Partial<Record<keyof ContactMessageFormData, string>>;
    isValid: boolean;
}
...
function validateContactMessageForm(data: Partial<ContactMessageFormData>): ValidationResult {
...
export default validateContactMessageForm;
